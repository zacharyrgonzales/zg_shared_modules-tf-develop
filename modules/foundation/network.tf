...
module "vpc-host-nonprod" {
  ...
  project_id   = module.vpc-host-nonprod-project.project_id
...
resource "google_compute_firewall" "vpc-host-nonprod-allow-iap-rdp" {
  ...
  project   = module.vpc-host-nonprod-project.project_id
  direction = "INGRESS"
  priority  = 10000
...
module "vpc-host-prod" {
  ...
  project_id   = module.vpc-host-prod-project.project_id
...
resource "google_compute_firewall" "vpc-host-prod-allow-iap-rdp" {
  ...
  project   = module.vpc-host-prod-project.project_id
  direction = "INGRESS"
  priority  = 10000
